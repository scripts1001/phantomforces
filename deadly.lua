if game.GameId == 113491250 then
	loadstring(game:HttpGet("https://raw.githubusercontent.com/scripts1001/phantomforces/main/deadly2.lua", true))()
else
	...
	local deadlyLib = library();

	local Window = deadlyLib:CreateWindow(HyperEscape.GUI.GUIToggleKey, "deadly");
	...
	if not IsArsenal then
		ESPSettingsSecor:CreateColorPicker("Highlight Outline", HyperEscape.esp.Highlights.OutlineColor, function(EOCC) HyperEscape.esp.Highlights.OutlineColor = EOCC; end);
		ESPSettingsSecor:CreateColorPicker("Highlight Fill", HyperEscape.esp.Highlights.FillColor, function(EFCC) HyperEscape.esp.Highlights.FillColor = EFCC; end);
	...
	SettingsInfoSector:CreateCoppyText("Made By sevenv1");
	SettingsInfoSector:CreateCoppyText("https://discord.gg/WaNJsYwJtP - deadly.wtf");
